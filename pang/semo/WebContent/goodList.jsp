					...
					<div class="blog-post padding-bottom-20">
						<c:forEach items="${goods }" var="good">
							...
							<div class="blog-post-date pull-left">
								...
								<a href="#" class="btn btn-primary">응모하기<i	class="icon-chevron-right readmore-icon"></i></a>
								<div style="display:none">
									<a href="#" class="btn btn-primary">삭제하기<i	class="icon-chevron-right readmore-icon"></i></a>
								</div>
							</div>
							<div class="blog">
