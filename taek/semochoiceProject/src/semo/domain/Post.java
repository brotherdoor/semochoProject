...
public class Post {
	...
	private boolean accuseCondition;
	...
	public boolean isAccuseCondition() {
		return accuseCondition;
	}
	public void setAccuseCondition(boolean accuseCondition) {
		this.accuseCondition = accuseCondition;
	}
