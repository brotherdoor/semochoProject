        ...
        <div class="container background-white">
            <div class="row margin-vert-30">
                ...
                <div class="col-md-6 col-md-offset-3 col-sm-offset-3">
                    <form class="signup-page margin-top-20" action="postModify.do" method="post">
                        <div class="signup-header">
                            <h2 class="margin-bottom-20">게시물 수정</h2> </div>
                            <input type="hidden" name="postId" value="${post.id }">
                        <label>제목</label> <span class="color-red">*</span>
                        <input class="form-control margin-bottom-10" type="text" name="title" value="${post.title }">
