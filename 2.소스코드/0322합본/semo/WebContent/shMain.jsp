                ...
                <div class="col-md-9">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <ul class="list-unstyled">
                                <li> <strong class="color-primary">투표 게시 횟수 : </strong>9am to 6pm</li>
                                <li> <strong class="color-primary">투표 참여 횟수 : </strong>10am to 3pm</li>
                                <li> <strong class="color-primary">경품 참여 횟수 : </strong>Closed</li>
                            </ul>
                        </div>
                    </div>
                    <!-- End recent Posts -->
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <ul class="posts-list margin-top-10">
                                <li>
                                    <div class="recent-post">
                                        <a href=""> <img class="pull-left" src="assets/img/blog/thumbs/thumb1.jpg" alt="thumb1"> </a> <a href="#" class="posts-list-title">Sidebar post example</a>
                                        <br> <span class="recent-post-date">
                                                July 30, 2013
                                            </span> </div>
                                    <div class="clearfix"></div>
                                ...
                                <li>
                                    <div class="recent-post">
                                        <a href=""> <img class="pull-left" src="assets/img/blog/thumbs/thumb2.jpg" alt="thumb2"> </a> <a href="#" class="posts-list-title">Sidebar post example</a>
                                        <br> <span class="recent-post-date">
                                                July 30, 2013
                                            </span> </div>
                                    <div class="clearfix"></div>
