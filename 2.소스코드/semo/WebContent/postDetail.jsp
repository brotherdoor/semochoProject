...
<link rel='stylesheet' href='${ctx }/assets/css/Nwagon.css' type='text/css'>
<script src='${ctx }/assets/js/Nwagon.js'></script>
...
<!-- Title -->
        ...
        <!-- Bootstrap Core CSS -->
        <link rel="stylesheet" href="${ctx }/assets/css/bootstrap.css" rel="stylesheet">
        <!-- Template CSS -->
        <link rel="stylesheet" href="${ctx }/assets/css/animate.css" rel="stylesheet">
        <link rel="stylesheet" href="${ctx }/assets/css/font-awesome.css" rel="stylesheet">
        <link rel="stylesheet" href="${ctx }/assets/css/nexus.css" rel="stylesheet">
        <link rel="stylesheet" href="${ctx }/assets/css/responsive.css" rel="stylesheet">
        <link rel="stylesheet" href="${ctx }/assets/css/custom.css" rel="stylesheet">
        <!-- Google Fonts-->
...
<body>
	<!-- Header -->
        ...
        <!-- === BEGIN CONTENT === -->
        <c:choose>
			<c:when test="${loginUser eq null }"></c:when>
			<c:otherwise>
				<div id="content">
					<div class="container background-white">
               			<div class="row margin-vert-30">
                    	<!-- Main Column -->
                    	<div class="col-md-9"><a href="postRegister.jsp" type="button" class="btn btn-info">게시물 등록</a></div>     
        		</div></div></div></div>
			</c:otherwise>
		</c:choose>
                            ...
                            <!-- Blog Item Body -->
                                ...
                                <div class="blog-post-body row margin-top-15">
                                    ...
                                    <div class="col-md-0" >
                                        ...
                                        <c:if test="${loginUser.id eq post.writerId }">
                                            ...
                                            <li class="list-group-item">
                                                <div class="row">
                                                    <div class="col-md-2 profile-thumb">
                                                        <a href="#">
                                                            <img class="media-object" src="${ctx }/grade.do?writerId=${comment.writerId }" alt="">
                                                        </a>
                                                    </div>
                                                    <div class="col-md-10">
