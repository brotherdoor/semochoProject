					...
					<div class="panel panel-default">
						...
						<c:forEach items="${goods }" var="good">
							...
							<div class="blog-post-date pull-left">
								...
								<a href="enter.do?goodId=${good.id }&useSemo=${good.useSemo}" class="btn btn-primary">응모하기<i class="icon-chevron-right readmore-icon"></i></a>
            ...
            <div class="container padding-vert-30">
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-3 margin-bottom-30">
                        <h3 class="margin-bottom-10"><b>세모컴퍼니</b></h3>
                        <ul class="menu">
                            <li>
