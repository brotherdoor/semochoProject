...
public class GoodRegisterControlloer extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String startDate = multi.getParameter("startDate").toString();
		String endDate = multi.getParameter("endDate").toString();
		...
		int endYear = Integer.parseInt(start[0]);
		int endMonth = Integer.parseInt(start[1]);
		int endDay = Integer.parseInt(start[2]);
