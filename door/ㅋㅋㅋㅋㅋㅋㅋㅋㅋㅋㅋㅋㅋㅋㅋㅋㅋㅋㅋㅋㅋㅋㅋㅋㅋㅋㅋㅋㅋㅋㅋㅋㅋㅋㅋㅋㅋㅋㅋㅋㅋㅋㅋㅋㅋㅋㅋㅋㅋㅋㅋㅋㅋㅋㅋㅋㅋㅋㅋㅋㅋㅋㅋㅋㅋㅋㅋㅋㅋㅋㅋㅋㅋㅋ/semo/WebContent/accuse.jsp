                                    ...
                                    <div class="tab-pane active in fade" id="faq">
                                        <div class="panel-group" id="accordion">
                                           ...
                                           <div class="panel panel-default panel-faq">
                                            ...
                                            <div class="panel panel-default panel-faq">
                                                <div class="panel-heading">
                                                    <div data-toggle="collapse" data-parent="#accordion" href="#faq-sub">
                                                        <h4 class="panel-title">${no.count } &nbsp ${accuse.title }
                                                            <span class="pull-right">
                                                               <a href="detail.do?postId=${accuse.id }"><i class="glyphicon glyphicon-plus">디테일</i></a> 
                                                                 <a href="deletePost.do?postId=${accuse.id }"><i class="glyphicon glyphicon-plus">삭제</i>
                                                                 <a href="deleteAccuse.do?postId=${accuse.id }"><i class="glyphicon glyphicon-plus">리셋</i>
                                                            </span>
                                                        </h4>
                                                    </div>
                                                </div>
                                                <div id="faq-sub" class="panel-collapse collapse">
                                                    ...
                                                    <p>이름 :${num.count }&nbsp ${comment.content}&nbsp${comment.writerId } </p>
                                                     </c:forEach>
                                                    </div>
                                                </div>
                                            </div>
